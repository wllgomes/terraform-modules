...
A [Terraform](https://www.terraform.io) module to  [Secret Manager](https://aws.amazon.com/pt/secrets-manager/) (without key/values)
...
```bash
module "Sample" {
  source      = "git::https://gitlab.com/phconsultoria/phconsultoria-tfm.git//modules/secret-manager"  
  name        = ""
}
```
<br>

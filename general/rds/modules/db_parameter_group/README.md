...
A [Terraform](https://www.terraform.io) module to  [RDS Parameter Group](https://aws.amazon.com/pt/rds/) custom parameter to RDS Instances
...
```bash
module "Sample" {
  source      = "git::https://gitlab.com/phconsultoria/phconsultoria-tfm.git//modules/rds/modules/db_parameter_group"  
  name        = ""
  family      = ""
}
```

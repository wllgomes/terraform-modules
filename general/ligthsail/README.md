...
A [Terraform](https://www.terraform.io) modules to deploy  [Lightsail](https://aws.amazon.com/pt/lightsail/) Instances and Load Balancers
...
```bash 
module "Sample" {
  source        = "git::https://gitlab.com/phconsultoria/phconsultoria-tfm.git//modules/lightsail/instances"
  name          = ""
  az            = ""
  blueprint_id  = ""
  bundle_id     = ""
...
```bash 
module "Sample" {
  source        = "git::https://gitlab.com/phconsultoria/phconsultoria-tfm.git//modules/lightsail/lb"
  instance_port = ""
  lb_name       = ""
}
```
